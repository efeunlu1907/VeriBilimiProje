...
| 19 | Açıklama (ML gerekçesi) | "Notebook'a kısa bir bölüm ekle: makine öğrenmesini neden uyguladık ve sklearn'in (train_test_split, StandardScaler, LogisticRegression, metrikler) bu işin neresinde olduğunu basitçe anlat." |
| 20 | Rapor güncelleme | "Eklenen eksik veri senaryosunu, hipotez testi sonucunu ve ML gerekçesini rapora işle; raporu 3-5 sayfa aralığında tut." |
